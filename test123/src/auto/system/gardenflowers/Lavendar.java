...
public class Lavendar extends Flower {
	private int Quantity_water;	
	private int waterlevel_inc=8;
	private int max_heat= 100;
	private int today_heat=0;
	private int temperature_max=25; //todo try constant class
	public Lavendar() {
		super();
		this.flower();
	...
	public void flower_sprinkle(int amoutOfWater) throws FlowerFullyGrownException{
		if(this.getFlowerStage()==FlowerStage.Stage4_Flowered){
			Log_Sys.writeLog(0, " The Sprinkler for plant "+getName()+" is switched off ",Lavendar.this);
			return;
		}
